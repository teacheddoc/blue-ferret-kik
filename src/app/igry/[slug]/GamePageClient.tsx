...
function getGameAssets(slug: string) {
  if (slug === 'trymaysia') {
    return {
      ...
      boxMockup: '/images/trymaysia/box-front-center-v9.webp',
      boxBack: '/images/trymaysia/box-front-bottom-v8.webp',
      boxTop: '/images/trymaysia/box-front-top-v8.webp',
      boxSideLeft: '/images/trymaysia/box-side-left-front-v9.webp',
      boxSideRight: '/images/trymaysia/box-side-right-front-v9.webp',
